...
public class CartAdapter extends BaseAdapter {
    ...
    public CartAdapter(Activity mainActivity, String[] prgmNameList, String[] prgmImages, String[] Id) {
    ...
    public View getView(final int position, View convertView, ViewGroup parent) {
        ...
        if (convertView == null) {
            ...
            viewHolder.tv = (TextView) convertView.findViewById(R.id.cart_textView1);
            viewHolder.tv2 = (TextView) convertView.findViewById(R.id.cart_textView2);
            viewHolder.tv3 = (TextView) convertView.findViewById(R.id.cart_textView3);
            viewHolder.img = (ImageView) convertView.findViewById(R.id.cart_imageView1);
        ...
        viewHolder.tv2.setText(x+ " pcs");
        x = (rand.nextInt(5) +1)*100;
        viewHolder.tv3.setText(x+ " bdt");
