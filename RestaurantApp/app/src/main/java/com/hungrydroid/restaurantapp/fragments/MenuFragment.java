...
import com.hungrydroid.restaurantapp.adapters.MenuAdapter;
...
public class MenuFragment extends Fragment {
    ...
    public void onViewCreated(View view, Bundle savedInstanceState) {
        ...
        lv = (ListView)getActivity().findViewById(R.id.menu_list1);
                ...
                try {
                    ...
                    //Toast.makeText(getActivity(), contacts.toString(), Toast.LENGTH_SHORT).show();
                       ...
                       for (int i = 0; i < contacts.length(); i++) {
                        ...
                        lv.setAdapter(new MenuAdapter(getActivity(), prgmNameList, prgmImages, prgmIds));
